...
class IRobotConnection {
   private:
    ...
    // If we want to implement some instruction with the Arduino board pins we
    // must use this instruction set ArduinoInstructionSet
    ...
    //************************************
    // Method:    createInt
    // Returns:   int				[out]	integer that we want to
    // create
    // Parameter: char * aux			[in]	Buffer where the hight byte and low byte
    // of the integer are Parameter: int hight				[in]
    // Position of the hight byte in the buffer Parameter: int low
    // [in]	Position of the low byte in the buffer
    //************************************
   ...
   public:
    ...
    // Description:												Starts the connection using
    // the simulator
    //************************************
    ...
    //************************************
    // Method:    connect
    // Parameter: bool useArduino						[in]	True -> if serial comunication
    // is going on it will choose Arduino config Description: Starts the
    // connection
    //************************************
    int connect();
    void disconnect();
