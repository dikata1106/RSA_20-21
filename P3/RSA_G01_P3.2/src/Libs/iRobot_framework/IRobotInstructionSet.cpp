...
Instruction iRobotInstructionSet::leds(int ledBit, int ledColor,
                                       int ledIntensity) {
    int miSize = 4;
    Instruction aux;
    aux.instruction = (char *)malloc(miSize * sizeof(char));
...
Instruction iRobotInstructionSet::pwmLowSideDrivers(int driver2, int driver1,
                                                    int driver0) {
    int miSize = 4;
    Instruction aux;
    aux.instruction = (char *)malloc(miSize * sizeof(char));
...
Instruction iRobotInstructionSet::driveDirect(int rightVelocity,
                                              int leftVelocity) {
    int miSize = 5;
    Instruction aux;
    aux.instruction = (char *)malloc(miSize * sizeof(char));
...
Instruction iRobotInstructionSet::script(int *commandList, int size) {
    ...
    aux.instruction[1] = size;
    for (int i = 0; i < size; i++)
        aux.instruction[i + 2] = commandList[i];
    aux.length = miSize;
    return aux;
}
