...
class iRobotInstructionSet {
   private:
    //************************************
    // Method:    intHightByte
    // Returns:   char						[out]	Hight byte of the
    // number
    // Parameter: short num					[in]	The
    // number
    //************************************
    ...
    //************************************
    // Method:    intLowByte
    // Returns:   char						[out]	Low byte of the
    // number
    // Parameter: short num					[in]	The
    // number
    //************************************
   ...
   public:
    //************************************
    // Method:    sensorReturn
    // Returns:   int						[out]	How many bytes generates the sensor as
    // response Parameter: char sensor				[in]
    // The sensor id
    //************************************
