...
class IRobotConnection {
   private:
    ...
    // create
    // Parameter: char * aux			[in]	Buffer where the hight byte and low byte of
    // the integer are
   ...
   public:
    ...
    // Description:												Starts the connection using the
    // simulator
    //************************************
    IRobotConnection(void);
    //************************************
    // Method:    IRobotConnection
    // Parameter: char * connectionType					[in]	"sim" if we want to use the
    // simulator, COMx if we want to use the serial communication
    //************************************
    ...
    //************************************
    // Method:    connect
    // Parameter: bool useArduino						[in]	True -> if serial comunication is
    // going on it will choose Arduino config Description:
