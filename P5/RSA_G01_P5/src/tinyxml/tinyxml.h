...
class TiXmlNode : public TiXmlBase {
    ...
    */
    ...
    const TiXmlNode* FirstChild(const char* value)
        const;  ///< The first child of this node with the matching 'value'.
    ...
    const TiXmlNode* LastChild(const char* value)
        const;  /// The last child of this node matching 'value'. Will be null
...
#endif
    int IntValue() const;  ///< Return the value of this attribute, converted to
                           ///< an integer.
    double DoubleValue()
